...
export const musicians: Musician[] = [
  ...
  },
  {
    ...
    biography: `
      ...
      Since he was just a small kid, he played with the best of people Tbilisi
      music scene could provide. After reaching the "certain" age, he started
      to study science of music with the Zura Ramishvili - musical father of
      many great artists. His public performances started from Movement Theatre
      Gem Sessions, but continued in mainc residence of Tbilisi Jazz scene at
      the time - Jazz Cafe Singer. He was growing and spreading roots of his soul
      into the depths of freedom, or Jazz. Since the inception of Jazz Club
      1984 for, Luka has been our loyal resident. His music is powerful and yet
      so beautiful. When he plays, he goes into the worlds, never seen before. Worlds you absolutely
      have to listen.
